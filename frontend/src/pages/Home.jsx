                ...
                {prediction.class_name === "Glioma" && (
                  <>
                    ...
                    <ul>
                      ...
                      <ul>
                        <h4>Diet Plan</h4>
                        <li>Vegetables: Green Leafy Vegetables like lettuce,spinach</li>
                        <li>Fruits : Consider Eating Citrus Fruits like orange</li>
                        <li>Pulses : Consider Eating Pulses and Peanuts</li>
                      </ul>
                    </ul>
                  </>
                )}
                  ...
                  <>
                    ...
                    <ul>
                      ...
                      <li>
                       ...
                       <ul>
                        <h4>Diet Plan</h4>
                        <li>Vegetables: Consider Eating more Vegetables like radish,carrot</li>
                        <li>Fruits : Consider Intake of liquid Juices Frequently</li>
                        <li>Pulses : Consider an very less intake </li>
                      </ul>
                    </ul>
                  </>
                )}
                    ...
                    <ul>
                      ...
                      <li>
                       ...
                       <ul>
                        <h4>Diet Plan</h4>
                        <li>Vegetables: Green Leafy Vegetables like lettuce,spinach</li>
                        <li>Fruits : Consider Eating Water fruits like watermelon,muskmelon</li>
                       <li> Pulses : Consider Eating Millets</li>
                      </ul>
                    </ul>
                  </>
                )}
                  ...
                  <>
                    ...
                    <ul>
                      ...
                      <li>
                       ...
                       <ul>
                        <h4>Diet Plan</h4>
                        <li>Vegetables: Go with freshly avaialable vegies like cucumber,spinach</li>
                        <li>Fruits : Consider Eating more hydrated fruits</li>
                        <li>Pulses : Consider Eating Ragi and Jower</li>
                      </ul>
                    </ul>
                  </>
                )}
